...
RenderLayer::RenderLayer() :
	...
	_renderFlags(RenderFlags::EnableColorCorrection | RenderFlags::EnableAlbedo | RenderFlags::EnableDiffuse | RenderFlags::EnableSpecular | RenderFlags::EnableEmissive),
